namespace RogersMobile.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RogersMobile.Models.DataContext>
    {
        ...
        protected override void Seed(RogersMobile.Models.DataContext context)
        {
